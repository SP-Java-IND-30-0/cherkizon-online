DROP DATABASE IF EXISTS comments_service_db;
DROP ROLE IF EXISTS dev;
CREATE USER dev WITH PASSWORD '12345';

CREATE DATABASE comments_service_db;
GRANT ALL PRIVILEGES ON DATABASE comments_service_db TO dev;

\c comments_service_db dev
